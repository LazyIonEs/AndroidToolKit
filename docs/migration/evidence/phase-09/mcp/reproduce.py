...
Usage: python3 docs/migration/evidence/phase-09/mcp/reproduce.py <JBR21_HOME>
"""
...
time.sleep = lambda seconds: original_sleep(max(3, seconds))
...
sys.argv = [str(root / "scripts/migration/hot_mcp_client.py"), sys.argv[1], "--phase3-smoke"]
hot_mcp_client.main()
