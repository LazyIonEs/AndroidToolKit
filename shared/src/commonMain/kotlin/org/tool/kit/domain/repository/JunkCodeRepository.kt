...
fun interface JunkSizeEstimator {
    fun bytes(packageCount: Int, activityCount: Int): Long
    fun range(packageCount: Int, activityCount: Int): JunkSizeEstimate = JunkSizeEstimate(bytes(packageCount, activityCount))
}
