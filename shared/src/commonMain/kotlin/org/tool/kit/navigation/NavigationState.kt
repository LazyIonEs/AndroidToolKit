...
private fun rememberNavBackStack(vararg elements: NavKey): NavBackStack<NavKey> {
    return rememberSerializable(
        serializer = NavBackStackSerializer(elementSerializer = platformNavKeySerializer())
    ) {
...
internal expect fun <T : NavKey> platformNavKeySerializer(): kotlinx.serialization.KSerializer<T>
