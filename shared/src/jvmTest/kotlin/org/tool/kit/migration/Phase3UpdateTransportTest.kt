...
class Phase3UpdateTransportTest {
    ...
    @Test fun checkTransportRetainsEffectiveLegacyHeadersRateLimitAndMalformedResponseMapping() = runBlocking {
        withServer { server ->
            ...
            // The legacy io.ktor.http.headers builder constructs a detached Headers value.
    ...
    @Test fun assetOrderArchitectureCaseAndNumericVersionRulesRemainFrozen() {
