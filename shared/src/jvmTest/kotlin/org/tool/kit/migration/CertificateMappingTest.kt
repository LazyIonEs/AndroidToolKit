...
class CertificateMappingTest {
    ...
    @Test fun rotatedApkPreservesTheKnownV31CertificateDuplicationInsteadOfFixingItDuringMigration() = runBlocking {
        ...
        assertEquals(mapped.data[2].sha256, mapped.data[3].sha256,
            "Known legacy defect: V3.1 visibility iterates the V3 list; correction belongs in a separate change")
    }
    ...
    @Test fun onlyTheLegacyErrorSetIsDisplayedAndPreservesItsTrailingNewline() {
        val input = unsigned()
