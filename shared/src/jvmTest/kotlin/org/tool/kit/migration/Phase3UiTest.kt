...
import org.tool.kit.feature.settings.VersionInfo
...
internal class ImmediatePreferencesRepository : PreferencesRepository {
    private val snapshot = MutableStateFlow(PreferencesSnapshot(ready = true))
    ...
    override suspend fun awaitReady() = snapshot.value
}
