package org.tool.kit.tests.feature.keystore
...
class KeyStoreGenerationUiTest {
    @Test fun actualFieldsSubmitTheExpectedRequestAndPageOwnerKeepsTheDraftAcrossThemeAndNavigation() =
        runDesktopComposeUiTest(width = 800, height = 572, testTimeout = 60.seconds) {
            ...
            container.koin.loadModules(listOf(module { viewModel { KeyStoreGenerationViewModel(get(), get(), get(), get()).also { vm = it } } }))
            try {
                setContent {
