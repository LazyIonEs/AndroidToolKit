package org.tool.kit.tests.core
...
class InputValidationTest {
    ...
    @Test fun settingsDraftsUpdateBeforeQueuedWritesAndFieldsDoNotOverwriteEachOther() = runTest {
        ...
        val vm = org.tool.kit.feature.setting.SettingsViewModel(repository, AllPathsExist, sink, RecordingDesktopActions())
        val store = ViewModelStore().also { it.put("validation", vm) }
        try {
            vm.onIntent(org.tool.kit.feature.setting.SettingsIntent.OutputPath(" /draft/path "))
            vm.onIntent(org.tool.kit.feature.setting.SettingsIntent.SignerSuffix("-draft"))
            vm.onIntent(org.tool.kit.feature.setting.SettingsIntent.OutputPath(" /latest/path "))
            vm.onIntent(org.tool.kit.feature.setting.SettingsIntent.SignerSuffix(""))
            vm.onIntent(org.tool.kit.feature.setting.SettingsIntent.Theme(DarkThemeConfig.DARK))
            vm.onIntent(org.tool.kit.feature.setting.SettingsIntent.DuplicateRemoval(false))
